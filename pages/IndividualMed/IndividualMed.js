...
const IndividualMed = () => {
    ...
    const overlayController = (e,value) => {
        ...
        settotalPrice(parent.lastElementChild.previousSibling.textContent.split('.')[1]);
    ...
    return (
        <>
            ...
            {overlay && <Form overlay={overlayController} medicineName={medName} totalPrice={totalPrice}/>}
        </>
    );
};
